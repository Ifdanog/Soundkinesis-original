...
function Step1() {
    ...
    function formSubmit(e) {
       navigate('/become-an-artist/step2')
        e.preventDefault();
    }
  ...
  return (
    ...
    <div className='bg-gradient-to-r from-purple to-pink h-fit pt-0 md:pt-8 pb-24'>
      <div className="relative">
          <div className="bg-white dark:bg-black py-10 px-10 rounded-none md:rounded-2xl w-full md:w-3/4 mx-auto mt-0 md:mt-2 text-center text-black">
              <p className="align-center dark:text-white">Step 1 of 4</p>
              <div className="w-1/3 mx-auto h-0.5 rounded-xl bg-darker-grey">
                  <div className="w-1/4 h-0.5 bg-gradient-to-r from-purple-900 to-pink-900 rounded-lg"></div>
              </div>
              ...
              <form className="mt-8" onSubmit={formSubmit}>
                  ...
                  <div className="w-full inline md:flex gap-4 my-8">
                      ...
                      <button className="text-xs md:text-sm w-full mt-4 md:mt-0 text-black px-0.5 py-0.5 bg-gradient-to-r hover:bg-gradient-to-l from-purple-900 to-pink-500 rounded-xl">
                          <div className="py-3 rounded-lg bg-white dark:bg-black dark:text-white font-medium btn-transt">
